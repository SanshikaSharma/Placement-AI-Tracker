...
import { FaRobot, FaChartLine, FaFileAlt, FaUserShield } from "react-icons/fa";

function Hero() {
return ( <section className="bg-linear-to-r from-blue-900 via-blue-700 to-indigo-700 text-white overflow-hidden"> <div className="max-w-7xl mx-auto px-8 py-20 grid lg:grid-cols-2 gap-16 items-center">
    {/* Left */}
